...
# MySQL for Data Exploration of Employee dataset
# Exploration Code
...
###########
-- Task: Creating a Database - Part I
...
###########
-- Task: Creating a Database - Part II

USE sales;


###########
-- Task: Fixed and Floating-Point Data Types
...
###########
-- Task: Using Databases and Tables
...
###########
-- Task: Additional Notes on Using Tables
...
###########
-- Task: FOREIGN KEY Constraint - Part I
...
###########
-- Task: FOREIGN KEY Constraint - Part II
...
###########
-- Task: NOT NULL Constraint - Part I
...
###########
-- Task: Coding Techniques and Best Practices - Part II
...
###########
-- Task: Loading the 'employees' Database
...
###########
-- Task: Other Comparison Operators
...
###########
-- Task: Introduction to Aggregate Functions    
...
###########
-- Task: The INSERT Statement - Part I
...
###########
-- Task: The INSERT Statement - Part II
...
###########
-- Task: Inserting Data INTO a New Table
...
###########
-- Task: The UPDATE Statement - Part I
...
###########
-- Task: The UPDATE Statement - Part II
...
###########
-- Task: The DELETE Statement - Part I
...
###########
-- Task: The DELETE Statement - Part II
...
###########
-- Task: Another Example of Using COALESCE()
...
###########
-- Task: The New and the Old Join Syntax
...
###########
-- Task: Using Aggregate Functions with Joins
...
###########
-- Task: Join more than Two Tables in SQL
...
###########
-- Task: Tips and Tricks for Joins
...
###########
-- Task: Subqueries with IN nested inside WHERE
...
###########
-- Task: Subqueries with EXISTS-NOT EXISTS nested inside WHERE
...
###########
-- Task: Subqueries nested in SELECT and FROM
...
###########
-- Task: The MySQL Syntax for Stored Procedures
...
###########
-- Task: Stored Procedures - Example - Part II
...
###########
-- Task: Another Way to Create a Procedure in MySQL

DROP PROCEDURE select_employees;


###########
-- Task: Stored Procedures with an Input Parameter
...
###########
-- Task: Stored Procedures with an Output Parameter
...
###########
-- Task: User-Defined Functions in MySQL
...
###########
-- Task: Stored Routines - Conclusion
...
###########
-- Task: Types of MySQL Variables - Local Variables
...
###########
-- Task: User-Defined vs System Variables
